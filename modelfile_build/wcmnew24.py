...
condition = condition[(deliverygw4['gestationday'] - condition['diffcondition']) <= 168] #24*7
...
medication2 = medication2[(medication2['gestationday'] - medication2['diffmedication']) <= 168] #24*7
...
def trimester(bp):
    if ((bp['gestationday'] - bp['diffbp']) < 84):
        return 1
    if ((bp['gestationday'] - bp['diffbp']) >=84) and ((bp['gestationday'] - bp['diffbp']) < 168):
        return 2
    else:
        return 3
...
def trimester(weight):
    if ((weight['gestationday'] - weight['diffweight']) < 84):
        return 1
    if ((weight['gestationday'] - weight['diffweight']) >=84) and ((weight['gestationday'] - weight['diffweight']) < 168):
        return 2
    else:
        return 3
...
visit = visit[(visit['gestationday'] - visit['diffvisit']) < 168] 
...
wcmmodelhistory.to_csv('/Users/bu/Documents/WCMC/PPD/ppdmodel1907/data/modelfile/wcm/wcmmodel24.csv', sep=',',index=0)
