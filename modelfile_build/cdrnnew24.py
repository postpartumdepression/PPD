...
condition = condition[(280 - condition['diffcondition']) <= 168 ]
...
medication2 = medication2[(280 - medication2['diffmedication']) <= 168 ]
...
def trimester(bp):
    if ((280 - bp['diffbp']) < 84):
        return 1
    if ((280 - bp['diffbp']) >=84) and ((280 - bp['diffbp']) < 168):
        return 2
    else:
        return 3
...
def trimester(weight):
    if ((280 - weight['diffweight']) < 84):
        return 1
    if ((280 - weight['diffweight']) >=84) and ((280 - weight['diffweight']) < 168):
        return 2
    else:
        return 3
...
visit = visit[(visit['diffvisit'] >= 0 ) & (visit['diffvisit'] <= 168)]
...
# cdrnmodel=cdrnmodel.fillna(0)
# cdrnmodel['ppd'].value_counts()
cdrnmodelhistory.to_csv('/Users/bu/Documents/WCMC/PPD/ppdmodel1907/data/modelfile/cdrn/cdrnnew24.csv', sep=',',index=0)
