...
condition = condition[(deliverygw4['gestationday'] - condition['diffcondition']) <= 210] #30*7
...
medication2 = medication2[(medication2['gestationday'] - medication2['diffmedication']) <= 210] #30*7
...
visit = visit[(visit['gestationday'] - visit['diffvisit']) < 210] 
...
wcmmodelhistory.to_csv('/Users/bu/Documents/WCMC/PPD/ppdmodel1907/data/modelfile/wcm/wcmmodel30.csv', sep=',',index=0)
