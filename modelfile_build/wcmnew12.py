...
condition = condition[(deliverygw4['gestationday'] - condition['diffcondition']) <= 84] #12*7
...
medication2 = medication2[(medication2['gestationday'] - medication2['diffmedication']) <= 84] #12*7
...
visit = visit[(visit['gestationday'] - visit['diffvisit']) < 84] 
...
wcmmodel = wcmmodel.drop(['weight3rd','sbp3rd','dbp3rd','weight2nd','sbp2nd','dbp2nd','amniocentesis'], axis=1)
...
wcmmodelhistory.to_csv('/Users/bu/Documents/WCMC/PPD/ppdmodel1907/data/modelfile/wcm/wcmmodel12.csv', sep=',',index=0)
